...
function hitungBMI() {
    ...
    document.getElementById('hasil').textContent = hasil.toFixed(1);
...
function reset() {
  document.getElementById("konten1").classList.add("hidden");
  document.getElementById("konten2").classList.remove('hidden');
  }
